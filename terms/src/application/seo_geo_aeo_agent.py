...
def run_research(website: str, n: int = 10, model: str = DEFAULT_MODEL, context: str = "") -> list[SearchTerm]:
    ...
    content = (
        ...
        Return the most common top {n} search terms people use to find sites like this,m most to least popular. For each term, include a one-sentence reason explaining why it ranks at that position (e.g. high ranked fro search volume, strong brand match, competitor gap, or long-tail intent).
